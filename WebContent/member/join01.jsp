...
<%@ include file="../include/global_head.jsp" %>
 ...
 <script>
    function check(){
    	...
    	var chk_box = document.getElementsByName("agreement1");
    	
    	if(chk_box[0].checked == false){
    		alert("약관에 동의하세요."); //동의하지 않을 경우 경고창
    		return false;
    	}
    }
</script>
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<form name="frm" method="post" action="join02.jsp" >
				<p style="text-align:center; margin-bottom:20px;"><input type="checkbox" name="agreement1" value="">이용약관과 개인정보취급방침에 동의합니다.</p>

				<p style="text-align:center; margin-bottom:20px"><a onclick="return check()" style="cursor:hand;" href="join02.jsp"><img src="../images/btn01.gif" /></a>&nbsp;&nbsp;<a href="../main/main.jsp"><img src="../images/btn02.gif" /></a></p>
				</form>
