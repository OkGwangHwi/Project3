...
<form enctype="multipart/form-data" action="EditProc.jsp?bname=<%=bname %>" method="get" onsubmit="return checkValidate(this);">
...
<tbody>
	...
	<tr>
		...
		<td>
			<input type="text" rows="10" class="form-control" name="content" value="<%=dto.getContent() %>" />
		</td>
	</tr>
	<tr>
		<th class="text-center" 
